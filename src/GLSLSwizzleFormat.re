...
let accept4 : [< `Vec4] => unit = (_) => ();
  ...
  let _bbbb = (`Vec4, BBBB, accept4);
  let _bbbg = (`Vec4, BBBG, accept4);
  let _bbbr = (`Vec4, BBBR, accept4);
  let _bbg = (`Vec3, BBG, accept3);
  let _bbga = (`Vec4, BBGA, accept4);
  let _bbgb = (`Vec4, BBGB, accept4);
  let _bbgg = (`Vec4, BBGG, accept4);
  let _bbgr = (`Vec4, BBGR, accept4);
  let _bbr = (`Vec3, BBR, accept3);
  let _bbra = (`Vec4, BBRA, accept4);
  let _bbrb = (`Vec4, BBRB, accept4);
  let _bbrg = (`Vec4, BBRG, accept4);
  let _bbrr = (`Vec4, BBRR, accept4);
  let _bg = (`Vec2, BG, accept2);
  let _bga = (`Vec3, BGA, accept3);
  ...
  let _bgbb = (`Vec4, BGBB, accept4);
  let _bgbg = (`Vec4, BGBG, accept4);
  let _bgbr = (`Vec4, BGBR, accept4);
  let _bgg = (`Vec3, BGG, accept3);
  let _bgga = (`Vec4, BGGA, accept4);
  let _bggb = (`Vec4, BGGB, accept4);
  let _bggg = (`Vec4, BGGG, accept4);
  let _bggr = (`Vec4, BGGR, accept4);
  let _bgr = (`Vec3, BGR, accept3);
  let _bgra = (`Vec4, BGRA, accept4);
  let _bgrb = (`Vec4, BGRB, accept4);
  let _bgrg = (`Vec4, BGRG, accept4);
  let _bgrr = (`Vec4, BGRR, accept4);
  let _br = (`Vec2, BR, accept2);
  let _bra = (`Vec3, BRA, accept3);
  ...
  let _gbbb = (`Vec4, GBBB, accept4);
  let _gbbg = (`Vec4, GBBG, accept4);
  let _gbbr = (`Vec4, GBBR, accept4);
  let _gbg = (`Vec3, GBG, accept3);
  let _gbga = (`Vec4, GBGA, accept4);
  let _gbgb = (`Vec4, GBGB, accept4);
  let _gbgg = (`Vec4, GBGG, accept4);
  let _gbgr = (`Vec4, GBGR, accept4);
  let _gbr = (`Vec3, GBR, accept3);
  let _gbra = (`Vec4, GBRA, accept4);
  let _gbrb = (`Vec4, GBRB, accept4);
  let _gbrg = (`Vec4, GBRG, accept4);
  let _gbrr = (`Vec4, GBRR, accept4);
  let _gg = (`Vec2, GG, accept2);
  let _gga = (`Vec3, GGA, accept3);
  ...
  let _ggbb = (`Vec4, GGBB, accept4);
  let _ggbg = (`Vec4, GGBG, accept4);
  let _ggbr = (`Vec4, GGBR, accept4);
  let _ggg = (`Vec3, GGG, accept3);
  let _ggga = (`Vec4, GGGA, accept4);
  let _gggb = (`Vec4, GGGB, accept4);
  let _gggg = (`Vec4, GGGG, accept4);
  let _gggr = (`Vec4, GGGR, accept4);
  let _ggr = (`Vec3, GGR, accept3);
  let _ggra = (`Vec4, GGRA, accept4);
  let _ggrb = (`Vec4, GGRB, accept4);
  let _ggrg = (`Vec4, GGRG, accept4);
  let _ggrr = (`Vec4, GGRR, accept4);
  let _gr = (`Vec2, GR, accept2);
  let _gra = (`Vec3, GRA, accept3);
  ...
  let _rbbb = (`Vec4, RBBB, accept4);
  let _rbbg = (`Vec4, RBBG, accept4);
  let _rbbr = (`Vec4, RBBR, accept4);
  let _rbg = (`Vec3, RBG, accept3);
  let _rbga = (`Vec4, RBGA, accept4);
  let _rbgb = (`Vec4, RBGB, accept4);
  let _rbgg = (`Vec4, RBGG, accept4);
  let _rbgr = (`Vec4, RBGR, accept4);
  let _rbr = (`Vec3, RBR, accept3);
  let _rbra = (`Vec4, RBRA, accept4);
  let _rbrb = (`Vec4, RBRB, accept4);
  let _rbrg = (`Vec4, RBRG, accept4);
  let _rbrr = (`Vec4, RBRR, accept4);
  let _rg = (`Vec2, RG, accept2);
  let _rga = (`Vec3, RGA, accept3);
  ...
  let _rgbb = (`Vec4, RGBB, accept4);
  let _rgbg = (`Vec4, RGBG, accept4);
  let _rgbr = (`Vec4, RGBR, accept4);
  let _rgg = (`Vec3, RGG, accept3);
  let _rgga = (`Vec4, RGGA, accept4);
  let _rggb = (`Vec4, RGGB, accept4);
  let _rggg = (`Vec4, RGGG, accept4);
  let _rggr = (`Vec4, RGGR, accept4);
  let _rgr = (`Vec3, RGR, accept3);
  let _rgra = (`Vec4, RGRA, accept4);
  let _rgrb = (`Vec4, RGRB, accept4);
  let _rgrg = (`Vec4, RGRG, accept4);
  let _rgrr = (`Vec4, RGRR, accept4);
  let _rr = (`Vec2, RR, accept2);
  let _rra = (`Vec3, RRA, accept3);
  ...
  let _yxw = (`Vec3, YXW, accept3);
  let _yxww = (`Vec4, YXWW, accept4);
  let _yxwx = (`Vec4, YXWX, accept4);
  let _yxwy = (`Vec4, YXWY, accept4);
  let _yxwz = (`Vec4, YXWZ, accept4);
  let _yxx = (`Vec3, YXX, accept3);
  let _yxxw = (`Vec4, YXXW, accept4);
  let _yxxx = (`Vec4, YXXX, accept4);
  let _yxxy = (`Vec4, YXXY, accept4);
  let _yxxz = (`Vec4, YXXZ, accept4);
  let _yxy = (`Vec3, YXY, accept3);
  let _yxyw = (`Vec4, YXYW, accept4);
  let _yxyx = (`Vec4, YXYX, accept4);
  let _yxyy = (`Vec4, YXYY, accept4);
  let _yxyz = (`Vec4, YXYZ, accept4);
  let _yxz = (`Vec3, YXZ, accept3);
  let _yxzw = (`Vec4, YXZW, accept4);
  let _yxzx = (`Vec4, YXZX, accept4);
  let _yxzy = (`Vec4, YXZY, accept4);
  let _yxzz = (`Vec4, YXZZ, accept4);
  let _yy = (`Vec2, YY, accept2);
  let _yyw = (`Vec3, YYW, accept3);
  let _yyww = (`Vec4, YYWW, accept4);
  let _yywx = (`Vec4, YYWX, accept4);
  let _yywy = (`Vec4, YYWY, accept4);
  let _yywz = (`Vec4, YYWZ, accept4);
  let _yyx = (`Vec3, YYX, accept3);
  let _yyxw = (`Vec4, YYXW, accept4);
  let _yyxx = (`Vec4, YYXX, accept4);
  let _yyxy = (`Vec4, YYXY, accept4);
  let _yyxz = (`Vec4, YYXZ, accept4);
  let _yyy = (`Vec3, YYY, accept3);
  let _yyyw = (`Vec4, YYYW, accept4);
  let _yyyx = (`Vec4, YYYX, accept4);
  let _yyyy = (`Vec4, YYYY, accept4);
  let _yyyz = (`Vec4, YYYZ, accept4);
  let _yyz = (`Vec3, YYZ, accept3);
  let _yyzw = (`Vec4, YYZW, accept4);
  let _yyzx = (`Vec4, YYZX, accept4);
  let _yyzy = (`Vec4, YYZY, accept4);
  let _yyzz = (`Vec4, YYZZ, accept4);
  let _yz = (`Vec2, YZ, accept2);
  let _yzw = (`Vec3, YZW, accept3);
  ...
  let _zxxx = (`Vec4, ZXXX, accept4);
  let _zxxy = (`Vec4, ZXXY, accept4);
  let _zxxz = (`Vec4, ZXXZ, accept4);
  let _zxy = (`Vec3, ZXY, accept3);
  let _zxyw = (`Vec4, ZXYW, accept4);
  let _zxyx = (`Vec4, ZXYX, accept4);
  let _zxyy = (`Vec4, ZXYY, accept4);
  let _zxyz = (`Vec4, ZXYZ, accept4);
  let _zxz = (`Vec3, ZXZ, accept3);
  let _zxzw = (`Vec4, ZXZW, accept4);
  let _zxzx = (`Vec4, ZXZX, accept4);
  let _zxzy = (`Vec4, ZXZY, accept4);
  let _zxzz = (`Vec4, ZXZZ, accept4);
  let _zy = (`Vec2, ZY, accept2);
  let _zyw = (`Vec3, ZYW, accept3);
  ...
  let _zyxx = (`Vec4, ZYXX, accept4);
  let _zyxy = (`Vec4, ZYXY, accept4);
  let _zyxz = (`Vec4, ZYXZ, accept4);
  let _zyy = (`Vec3, ZYY, accept3);
  let _zyyw = (`Vec4, ZYYW, accept4);
  let _zyyx = (`Vec4, ZYYX, accept4);
  let _zyyy = (`Vec4, ZYYY, accept4);
  let _zyyz = (`Vec4, ZYYZ, accept4);
  let _zyz = (`Vec3, ZYZ, accept3);
  let _zyzw = (`Vec4, ZYZW, accept4);
  let _zyzx = (`Vec4, ZYZX, accept4);
  let _zyzy = (`Vec4, ZYZY, accept4);
  let _zyzz = (`Vec4, ZYZZ, accept4);
  let _zz = (`Vec2, ZZ, accept2);
  let _zzw = (`Vec3, ZZW, accept3);
  ...
  let _zzxx = (`Vec4, ZZXX, accept4);
  let _zzxy = (`Vec4, ZZXY, accept4);
  let _zzxz = (`Vec4, ZZXZ, accept4);
  let _zzy = (`Vec3, ZZY, accept3);
  let _zzyw = (`Vec4, ZZYW, accept4);
  let _zzyx = (`Vec4, ZZYX, accept4);
  let _zzyy = (`Vec4, ZZYY, accept4);
  let _zzyz = (`Vec4, ZZYZ, accept4);
  let _zzz = (`Vec3, ZZZ, accept3);
  let _zzzw = (`Vec4, ZZZW, accept4);
  let _zzzx = (`Vec4, ZZZX, accept4);
  let _zzzy = (`Vec4, ZZZY, accept4);
  let _zzzz = (`Vec4, ZZZZ, accept4);
